    ...
    S.SilicaFlickable {
        ...
        Column {
            ...
            S.ValueButton {
                width: parent.width
                label: qsTr("Selected")
                value: !!fruitCombo.currentData ? fruitCombo.currentData : qsTr("nothing")
            }
            ...
            S.ValueButton {
                width: parent.width
                label: qsTr("Details")
                value: !!foodCombo.currentData ? foodCombo.currentData : qsTr("no details available")
            }

            S.ValueButton {
                width: parent.width
                label: qsTr("Index by value")
