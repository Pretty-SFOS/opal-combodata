...
briefDescription: QML module for combo boxes with value access in Sailfish apps

# description of this module: may use rich text and will be translated in
# Opal Gallery. Line breaks can included with '\n' but should be avoided.
description: This module provides an extension for combo boxes to access the current value instead of the label.
