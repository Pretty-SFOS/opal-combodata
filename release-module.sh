...
function copy_files() {
    ...
    rm "$QML_BASE/Opal/ComboData/private/ExtraTranslations.qml" || true
    rmdir --ignore-fail-on-non-empty "$QML_BASE/Opal/ComboData/private"
    ...
    printf "%s\n" \
        ...
        "}" "" > "$QML_BASE/Opal/ComboData/OpalComboDataAttribution.qml"
    # REUSE-IgnoreEnd
}
